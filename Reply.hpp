...
public:
	...
	explicit Reply(RPL::TRACECONNECTING, const std::string &, const std::string &, const std::string &);
	explicit Reply(RPL::TRACEHANDSHAKE, const std::string &, const std::string &, const std::string &);
	explicit Reply(RPL::TRACEUNKNOWN, const std::string &, const std::string &, const std::string &);
	explicit Reply(RPL::TRACEUSER, const std::string &, const std::string &, const std::string &);
	explicit Reply(RPL::TRACESERVER, const std::string &, const std::string &, const std::string &);
