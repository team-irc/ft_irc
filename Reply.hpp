...
private:
	std::string					_msg;
public:
	Reply(ERR::NOSUCHNICK, const std::string &);
	Reply(ERR::NOSUCHSERVER, const std::string &);
	Reply(ERR::NOSUCHCHANNEL, const std::string &);
	Reply(ERR::CANNOTSENDTOCHAN, const std::string &);
	Reply(ERR::TOOMANYCHANNELS, const std::string &);
	Reply(ERR::WASNOSUCHNICK, const std::string &);
	Reply(ERR::TOOMANYTARGETS, const std::string &);
	Reply(ERR::NOORIGIN);
	Reply(ERR::NORECIPIENT, const std::string &);
	Reply(ERR::NOTEXTTOSEND);
	Reply(ERR::NOTOPLEVEL, const std::string &);
	Reply(ERR::WILDTOPLEVEL, const std::string &);
	Reply(ERR::UNKNOWNCOMMAND, const std::string &);
	Reply(ERR::NOMOTD);
	Reply(ERR::NOADMININFO, const std::string &);
	Reply(ERR::FILEERROR, const std::string &, const std::string &);
	Reply(ERR::NONICKNAMEGIVEN);
	Reply(ERR::ERRONEUSNICKNAME, const std::string &);
	Reply(ERR::NICKNAMEINUSE, const std::string &);
	Reply(ERR::NICKCOLLISION, const std::string &);
	Reply(ERR::USERNOTINCHANNEL, const std::string &, const std::string &);
	Reply(ERR::NOTONCHANNEL, const std::string &);
	Reply(ERR::USERONCHANNEL, const std::string &, const std::string &);
	Reply(ERR::NOLOGIN, const std::string &);
	Reply(ERR::SUMMONDISABLED);
	Reply(ERR::USERSDISABLED);
	Reply(ERR::NOTREGISTERED);
	Reply(ERR::NEEDMOREPARAMS, const std::string &);
	Reply(ERR::ALREADYREGISTRED);
	Reply(ERR::NOPERMFORHOST);
	Reply(ERR::PASSWDMISMATCH);
	Reply(ERR::YOUREBANNEDCREEP);
	Reply(ERR::KEYSET, const std::string &);
	Reply(ERR::CHANNELISFULL, const std::string &);
	Reply(ERR::UNKNOWNMODE, const std::string &);
	Reply(ERR::INVITEONLYCHAN, const std::string &);
	Reply(ERR::BANNEDFROMCHAN, const std::string &);
	Reply(ERR::BADCHANNELKEY, const std::string &);
	Reply(ERR::NOPRIVILEGES);
	Reply(ERR::CHANOPRIVSNEEDED, const std::string &);
	Reply(ERR::CANTKILLSERVER);
	Reply(ERR::NOOPERHOST);
	Reply(ERR::UMODEUNKNOWNFLAG);
	Reply(ERR::USERSDONTMATCH);
public:
	Reply(RPL::NONE);
public:
	~Reply();
