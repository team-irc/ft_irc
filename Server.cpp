...
Server::Server(const std::string &server_name, const std::string &hopcount, const std::string &info) : _name(server_name), _info(info)
{
...
Server::Server(Server const &copy) : _hopcount(copy._hopcount), _info(copy._info), _name(copy._name), _password(copy._password), _connected_socket(copy._connected_socket)
{
}
